---- MODULE Phase6DistributedAuthority_TTrace_1787752452 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Phase6DistributedAuthority_TTrace_1787752452.json", _TETrace)
...
\*
\*trace == IODeserialize("Phase6DistributedAuthority_TTrace_1787752452.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Phase6DistributedAuthority_TTrace_1787752452 ----
CONSTANTS
    Nodes = { N1 , N2 }
    Workers = { W1 }
    Invocations = { I1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Aug 26 14:54:22 WAT 2026
---- MODULE Phase6DistributedAuthority_TTrace_1787755609 ----
...
_prop ==
    ~<>[](
        ...
        partition = ({})
        /\
        assignments = ({[epA |-> 2, gen |-> 2, worker |-> W1, invocation |-> I1, attempt |-> 1]})
        /\
        nodeEpoch = ((N1 :> 2 @@ N2 :> 0))
        /\
        epochL = ((I1 :> 2))
        /\
        nodeWAL = ((N1 :> <<[epA |-> 2, type |-> "ASSIGN", seq |-> 1, payload |-> I1], [epA |-> 2, type |-> "ASSIGN", seq |-> 2, payload |-> I1]>> @@ N2 :> <<>>))
        /\
        quarantine = ({})
        /\
        network = ({})
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Phase6DistributedAuthority_TTrace_1787755609.json", _TETrace)
...
\*
\*trace == IODeserialize("Phase6DistributedAuthority_TTrace_1787755609.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([leader |-> N1,workerGen |-> (W1 :> 1),partition |-> {},assignments |-> {},nodeEpoch |-> (N1 :> 2 @@ N2 :> 0),epochL |-> (I1 :> 0),nodeWAL |-> (N1 :> <<>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 2]),
    ([leader |-> N1,workerGen |-> (W1 :> 1),partition |-> {},assignments |-> {[epA |-> 2, gen |-> 1, worker |-> W1, invocation |-> I1, attempt |-> 1]},nodeEpoch |-> (N1 :> 2 @@ N2 :> 0),epochL |-> (I1 :> 1),nodeWAL |-> (N1 :> <<[epA |-> 2, type |-> "ASSIGN", seq |-> 1, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 2]),
    ([leader |-> N1,workerGen |-> (W1 :> 1),partition |-> {},assignments |-> {},nodeEpoch |-> (N1 :> 2 @@ N2 :> 0),epochL |-> (I1 :> 1),nodeWAL |-> (N1 :> <<[epA |-> 2, type |-> "ASSIGN", seq |-> 1, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 2]),
    ([leader |-> N1,workerGen |-> (W1 :> 2),partition |-> {},assignments |-> {},nodeEpoch |-> (N1 :> 2 @@ N2 :> 0),epochL |-> (I1 :> 1),nodeWAL |-> (N1 :> <<[epA |-> 2, type |-> "ASSIGN", seq |-> 1, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 2]),
    ([leader |-> N1,workerGen |-> (W1 :> 2),partition |-> {},assignments |-> {[epA |-> 2, gen |-> 2, worker |-> W1, invocation |-> I1, attempt |-> 1]},nodeEpoch |-> (N1 :> 2 @@ N2 :> 0),epochL |-> (I1 :> 2),nodeWAL |-> (N1 :> <<[epA |-> 2, type |-> "ASSIGN", seq |-> 1, payload |-> I1], [epA |-> 2, type |-> "ASSIGN", seq |-> 2, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 2]),
    ([leader |-> N1,workerGen |-> (W1 :> 2),partition |-> {},assignments |-> {[epA |-> 2, gen |-> 2, worker |-> W1, invocation |-> I1, attempt |-> 1]},nodeEpoch |-> (N1 :> 3 @@ N2 :> 0),epochL |-> (I1 :> 2),nodeWAL |-> (N1 :> <<[epA |-> 2, type |-> "ASSIGN", seq |-> 1, payload |-> I1], [epA |-> 2, type |-> "ASSIGN", seq |-> 2, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 3]),
    ([leader |-> "NONE",workerGen |-> (W1 :> 2),partition |-> {},assignments |-> {[epA |-> 2, gen |-> 2, worker |-> W1, invocation |-> I1, attempt |-> 1]},nodeEpoch |-> (N1 :> 2 @@ N2 :> 0),epochL |-> (I1 :> 2),nodeWAL |-> (N1 :> <<[epA |-> 2, type |-> "ASSIGN", seq |-> 1, payload |-> I1], [epA |-> 2, type |-> "ASSIGN", seq |-> 2, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 3])
    >>
----
...
---- CONFIG Phase6DistributedAuthority_TTrace_1787755609 ----
CONSTANTS
    Nodes = { N1 , N2 }
    Workers = { W1 }
    Invocations = { I1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Aug 26 15:48:08 WAT 2026
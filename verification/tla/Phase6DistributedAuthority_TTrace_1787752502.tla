---- MODULE Phase6DistributedAuthority_TTrace_1787752502 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Phase6DistributedAuthority_TTrace_1787752502.json", _TETrace)
...
\*
\*trace == IODeserialize("Phase6DistributedAuthority_TTrace_1787752502.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([leader |-> N1,workerGen |-> (W1 :> 1),partition |-> {},assignments |-> {},nodeEpoch |-> (N1 :> 0 @@ N2 :> 0),epochL |-> (I1 :> 0),nodeWAL |-> (N1 :> <<>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 1])
    >>
----
...
---- CONFIG Phase6DistributedAuthority_TTrace_1787752502 ----
CONSTANTS
    Nodes = { N1 , N2 }
    Workers = { W1 }
    Invocations = { I1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Aug 26 14:55:11 WAT 2026
---- MODULE Phase6DistributedAuthority_TTrace_1787752531 ----
...
_inv ==
    ~(
        ...
        partition = ({})
        /\
        assignments = ({[epA |-> 1, worker |-> W1, gen |-> 1, invocation |-> I1, attempt |-> 1]})
        /\
        nodeEpoch = ((N1 :> 2 @@ N2 :> 0))
        /\
        epochL = ((I1 :> 1))
        /\
        nodeWAL = ((N1 :> <<[type |-> "ASSIGN", seq |-> 1, epA |-> 1, payload |-> I1]>> @@ N2 :> <<>>))
        /\
        quarantine = ({})
        /\
        network = ({})
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Phase6DistributedAuthority_TTrace_1787752531.json", _TETrace)
...
\*
\*trace == IODeserialize("Phase6DistributedAuthority_TTrace_1787752531.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([leader |-> N1,workerGen |-> (W1 :> 1),partition |-> {},assignments |-> {},nodeEpoch |-> (N1 :> 1 @@ N2 :> 0),epochL |-> (I1 :> 0),nodeWAL |-> (N1 :> <<>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 1]),
    ([leader |-> N1,workerGen |-> (W1 :> 1),partition |-> {},assignments |-> {[epA |-> 1, worker |-> W1, gen |-> 1, invocation |-> I1, attempt |-> 1]},nodeEpoch |-> (N1 :> 1 @@ N2 :> 0),epochL |-> (I1 :> 1),nodeWAL |-> (N1 :> <<[type |-> "ASSIGN", seq |-> 1, epA |-> 1, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 1]),
    ([leader |-> N1,workerGen |-> (W1 :> 1),partition |-> {},assignments |-> {[epA |-> 1, worker |-> W1, gen |-> 1, invocation |-> I1, attempt |-> 1]},nodeEpoch |-> (N1 :> 2 @@ N2 :> 0),epochL |-> (I1 :> 1),nodeWAL |-> (N1 :> <<[type |-> "ASSIGN", seq |-> 1, epA |-> 1, payload |-> I1]>> @@ N2 :> <<>>),quarantine |-> {},network |-> {},epochA |-> 2])
    >>
----
...
---- CONFIG Phase6DistributedAuthority_TTrace_1787752531 ----
CONSTANTS
    Nodes = { N1 , N2 }
    Workers = { W1 }
    Invocations = { I1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Aug 26 14:56:19 WAT 2026
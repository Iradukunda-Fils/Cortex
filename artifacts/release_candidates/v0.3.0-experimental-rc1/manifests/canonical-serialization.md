...
NullVal      ::= "N" ;              (* Wire tag byte: 0x4E 'N' *)
BoolVal      ::= "B1" | "B0" ;
IntVal       ::= "I" ("0" | ("-"? [1-9] [0-9]*)) ;
FloatVal     ::= "D" IEEE754_BE_HEX ; (* Wire tag byte: 0x44 'D' for Double-precision IEEE 754 Float64 *)
...
- **Format**: `D` followed by a 16-character lowercase hexadecimal string representing 64-bit IEEE 754 Big-Endian binary encoding (`D` + 8 bytes in hex).
- **Normalization**:

...
class StateGenerator:
    ...
    def generate_initial_state(self) -> dict[str, Any]:
        ...
        stcr_file.append(
            {"index": 0, "valid": root_v, "permissions": root_mask, "base_address": root_base, "epoch": root_epoch}
        )
        ...
        for reg_id in range(1, 32):
            ...
            stcr_file.append(
                {"index": reg_id, "valid": is_valid, "permissions": mask, "base_address": base, "epoch": epoch}
            )

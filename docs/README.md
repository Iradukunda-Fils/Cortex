...
- **[Phase 4 Routing & Dispatch Specification](architecture/phase_4_routing_and_dispatch_specification.md)**: (*DESIGN REVIEW DRAFT / IMPLEMENTATION BLOCKED*) 8-stage dispatch pipeline, candidate filtering, least-load selection, state fencing, failure matrix, and RD-1..12 gates.

...
| **WORK-031** | InvocationLedger Snapshot Checkpointing & Memory Compaction | #31 | Local | Working Tree | `test_invocation_ledger_compaction.py` (6 tests) | Empirical Recovery Equivalence | v0.4.1-exp | 2026-08-22 | VERIFIED_COMPLETE (`IMPLEMENTATION-VERIFIED / RECOVERY-EQUIVALENCE TESTED FOR THE CERTIFIED DOMAIN`) |
